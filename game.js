    ...
    shoot() {
        ...
        if (this.laserLevel > 0) {
            ...
            if (this.wingCannonsLevel >= 2) {
                // Disparos rectos desde las alas (como nivel 2 de Wing Cannons)
            ...
            if (this.wingCannonsLevel >= 3) {
                 // Disparos extra en ángulo abierto (como nivel 3 de Wing Cannons)
...
function applyPowerUp(player, type) {  
    ...
    switch (type) {
        ...
        case 'heavyCannon':
            ...
            player.laserLevel = 0; 
            clearTimeout(player.heavyCannonTimeoutId); // Limpia el temporizador del jugador
            clearTimeout(player.laserTimeoutId);       // Limpia el otro por si acaso
            player.heavyCannonTimeoutId = setTimeout(() => { // Asigna al jugador
                player.heavyCannonLevel = 0; 
            }, 15000);
            break;
        case 'laser':
            ...
            player.heavyCannonLevel = 0; 
            clearTimeout(player.heavyCannonTimeoutId); // Limpia el otro por si acaso
            clearTimeout(player.laserTimeoutId);       // Limpia el temporizador del jugador
            player.laserTimeoutId = setTimeout(() => { // Asigna al jugador
                player.laserLevel = 0; 
